    ...
    <div className="min-h-screen flex">
      <div className="hidden lg:flex lg:w-[45%] relative flex-col">
        <div
          ...
          style={{ backgroundImage: `url('https://images.unsplash.com/photo-1503656142023-618e7d1f435a?w=1200&q=85')` }}
        />
        ...
        <div className="relative z-10 mt-auto p-10">
          <blockquote className="text-cream/90 text-xl font-display italic leading-relaxed mb-4">
            "Hosting KEEP exchanges has energised our entire keeping team. The fresh perspectives are invaluable."
          </blockquote>
          <p className="text-sage/70 text-sm">— Head of Animals, Partner Collection</p>
        </div>
      </div>
